...
function SignUpFormContent() {
  ...
  const handleGoogleSignUp = () => {
    // Redirect to student-dashboard upon Google sign up
  ...
  return (
    <div className="w-full max-w-[440px] mx-auto">
      ...
      <p className="font-inter text-[#414754] text-sm mb-6">
      ...
      <form onSubmit={handleSubmit} className="w-full space-y-4">
        ...
        <div className="w-full">
          <label
            htmlFor="full-name"
            className="block font-inter font-bold text-xs text-[#1b1c1c] mb-1.5"
          >
            Full Name
          </label>
          <input
            ...
            className="w-full h-11 px-4 bg-[#f0eded] border border-[#c1c6d6]/50 rounded-xl text-sm font-inter text-[#1b1c1c] placeholder-[#727785] focus:outline-none focus:bg-white focus:border-[#005bbf] focus:ring-2 focus:ring-[#005bbf]/20 transition-all"
          />
        </div>
        ...
        <div className="w-full">
          ...
          <div className="relative w-full">
            <input
              ...
              required
              placeholder="••••••••"
              className="w-full h-11 pl-4 pr-10 bg-[#f0eded] border border-[#c1c6d6]/50 rounded-xl text-sm font-inter text-[#1b1c1c] placeholder-[#727785] focus:outline-none focus:bg-white focus:border-[#005bbf] focus:ring-2 focus:ring-[#005bbf]/20 transition-all"
            />
            <button
              type="button"
          ...
          <p className="mt-1.5 text-xs text-[#414754] font-inter">
        ...
        <button
          type="submit"
          className="w-full h-11 bg-[#005bbf] hover:bg-[#004493] text-white font-quicksand font-bold text-sm sm:text-base rounded-full shadow-md hover:shadow-lg active:scale-[0.99] transition-all flex items-center justify-center gap-2 mt-2"
        >
          <span>Sign Up</span>
        ...
        <div className="flex items-center my-4 w-full">
          ...
          <span className="px-3 text-xs font-inter text-[#727785] uppercase tracking-wider">or</span>
          <div className="flex-1 border-t border-[#c1c6d6]/50" />
        </div>
        ...
        <button
          ...
          className="w-full h-11 bg-white border border-[#c1c6d6] text-[#1b1c1c] font-quicksand font-bold text-xs sm:text-sm rounded-full hover:bg-[#f0eded] transition-colors shadow-sm flex items-center justify-center gap-2.5 active:scale-95"
        >
          <Image
  ...
  return (
    <div className="w-full min-h-screen bg-[#fbf9f8] text-[#1b1c1c]">
      <div className="w-full min-h-screen grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="w-full min-h-screen flex flex-col justify-center items-center px-6 sm:px-12 lg:px-16 py-8 bg-white overflow-y-auto">
